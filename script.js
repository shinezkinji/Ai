...
/* =========================================================
   AP AI — CHAT DENGAN WEB SEARCH (Groq API - GRATIS, limit besar)
   ========================================================= */
  ...
  try{
    const res = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        model: GROQ_MODEL,
        messages: [
          { role: 'system', content: 'Kamu adalah AP AI, asisten yang menjawab pertanyaan seputar keamanan jaringan dan topik umum lain dalam Bahasa Indonesia, singkat dan jelas. Gunakan web search bila butuh info terkini.' },
          ...history
        ]
      })
    });
