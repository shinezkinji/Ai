...
/* =========================================================
   AP AI — CHAT DENGAN WEB SEARCH (Anthropic API)
   ========================================================= */
...
// Tampilkan kotak API key kalau belum ada key di sesi ini
...
async function askAPAI(question){
  ...
  if(!apiKey){
    addMessage('ai', 'Masukkan Anthropic API key di kotak atas dulu ya, biar aku bisa jawab.');
    return;
  }
  ...
  try{
    const res = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1200,
        system: 'Kamu adalah AP AI, asisten yang menjawab pertanyaan seputar keamanan jaringan dan topik umum lain dalam Bahasa Indonesia, singkat dan jelas. Gunakan web search bila butuh info terkini.',
